...
component {
	...
	// Module Entry Point
	this.entryPoint			= "AlphaVantage";
	// Inherit Entry Point
	this.inheritEntryPoint 	= false;
	// Model Namespace
	this.modelNamespace		= "AlphaVantage";
	// CF Mapping
	this.cfmapping			= "AlphaVantage";
	// Auto-map models
	...
	function configure(){
		...
		settings = {
			apiKey : getSystemSetting( "ALPHAVANTAGE_API_KEY", "blablasecret" ),
			apiURL : getSystemSetting( "ALPHAVANTAGE_API_URL", "https://alphavantage.io/api/v1" ),
		};

		// Binder Mappings
		binder.map( "AlphaVantageClient" )
